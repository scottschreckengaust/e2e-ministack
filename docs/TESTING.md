...
| Functional — robustness           | mutation — Stryker (`npm run test:mutation`)                                                        | Mutates `lambda/index.js` against the unit tier; CI breaks under the **80%** floor set in `stryker.config.mjs`                                                                                                                               | **Implemented**                                   |
